...
(function ($, Sys) {
    ...
    $(document).ready(function () {
        ...
        $('.JSFaq .dnnFormItem table input[type=text]').focus(function () {
            var $this = $(this);

            $('.JSFaq .dnnFormItem table tr.active td').addClass('no-edit-cell');
        ...
        $('.JSFaq table tbody .cbSelect input:checkbox').each(function () {
            ...
            if ($n === $t) $('.JSFaq table thead .cbSelectAll input:checkbox').prop('checked', true);else $('.JSFaq table thead .cbSelectAll input:checkbox').prop('checked', false);
        ...
        //SCROLL TABLES
        if ($('.JSFaq .edit .table tbody').height() == 185) $('.JSFaq .edit .table').addClass('scroll').find('thead tr').append('<th class="add-custom"></th>');else $('.JSFaq .edit .table').removeClass('scroll').find('thead tr .add-custom').remove();

        if ($('.JSFaq .select .table tbody').height() == 245) $('.JSFaq .select .table').addClass('scroll').find('thead tr').append('<th class="add-custom"></th>');else $('.JSFaq .select .table').removeClass('scroll').find('thead tr .add-custom').remove();

        //DISPALY/HIDE PANEL DEFINITION
        $('.JSFaq .hidder input:checkbox').each(function () {
        ...
        $('.JSFaq .unhidder input:checkbox').each(function () {
            var $target = $(this).parent().data('target');
        ...
        $('.JSFaq input:file').each(function () {
            var $this = $(this),
        ...
        $('.JSFaq .check-equal').each(function () {
        ...
        $('.JSFaq .hidder-radio-option input:radio').each(function () {
        ...
        function RefreshPostBack() {
            ...
            $('.JSFaq .lbAnimation, .JSFaq .lbTransition').each(function () {
                var $value = $(this).val(),
        ...
        $(window).scroll(function () {
            if ($(this).scrollTop() > 100) $('.JSFaq .scroll-action').fadeIn();else $('.JSFaq .scroll-action').fadeOut();
        });
        ...
        $('.JSFaq [data-toggle="tooltip"]').tooltip({
